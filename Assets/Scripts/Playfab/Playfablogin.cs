...
public class Playfablogin : MonoBehaviour
{
    ...
    public TextMeshPro recycledText;
    [SerializeField]
    public int coins;
    [Header("BANNED")]
    ...
    void OnGetUserInventorySuccess(GetUserInventoryResult result)
    {
        ...
        currencyText.text = "CURRENT SCRAP: " + coins.ToString() + " ";
        recycledText.text = "TOTAL RECYCLED SCRAP: " + coins.ToString();
    }
    ...
    private void OnError(PlayFabError error)
    {
        ...
        Debug.Log("ATTEMPTING TO RELOG (PLAYFLABLOGIN)");
        login();
